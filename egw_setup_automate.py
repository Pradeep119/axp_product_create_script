...
parentDir= "/home/pradeepk/Desktop/product_create_script/product"
axpProductZipPath="/home/pradeepk/Desktop/product_create_script/axp-dep-6.0.1-SNAPSHOT.zip"
kmProductZipPath="/home/pradeepk/Desktop/product_create_script/wso2is-5.10.0.zip"
dbUsername='root'
dbPassword='root123'
apiMgtDb='egw_apimgtdb'
regDb='egw_egdb'
userStoreDb='egw_userstoredb'
depdb='egw_proddepdb'
activitiDb='egw_activitidb'
rateDb='egw_rateDb'
statsDb='egw_apistatsdb'
#configuration end
...
def gwSetup():
    ...
    updateDatasourceDbToml('WSO2TELCO_DEP_DB',GW_HOME_DIR,depdb)
...
def portalSetup():
    ...
    updateDatasourceDbToml('WSO2TELCO_DEP_DB',PTL_HOME_DIR,depdb)
    updateDatasourceDbToml('ACTIVITI_DB',PTL_HOME_DIR,activitiDb)
    updateDatasourceDbToml('WSO2TELCO_RATE_DB',PTL_HOME_DIR,rateDb)
    updateDatasourceDbToml('WSO2AM_STATS_DB',PTL_HOME_DIR,statsDb)
...
def updateDatasourceDbToml(datasourceId, tomlPackHome, dbName):
    ...
    if(data['datasource'][0]['id'] == datasourceId):
        data['datasource'][0]['url']="jdbc:mysql://localhost:3306/"+dbName+"?autoReconnect=true&amp;relaxAutoCommit=true&amp;useSSL=false&amp;"
        data['datasource'][0]['username']=dbUsername
        data['datasource'][0]['password']=dbPassword 
